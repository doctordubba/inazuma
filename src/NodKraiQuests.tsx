...
const quests = [
  ...
  { id:17, tier:4, chain:"standalone", name:"Nod-Krai — Full Region Sweep", time:"10-15 hours (full ~18-20 quest set + chest exploration)", region:"All of Nod-Krai (Lempo, Hiisi, Paha)", activate:"Natural progression. World quests pop on the map as you explore.", prereqs:"AR 30+ · Nod-Krai unlocked", notes:"Aggregate entry for what isn't enumerated individually. Includes remaining standalone world quests, ~293+ chests, Valiant Chronicles. Total chest payout ~2,400-3,000 primogems.", rewards:"~2,400-3,000 Primogems from chests · Adv EXP · Mora · Hero's Wit · 180 primo from Valiant Chronicles" },
];
