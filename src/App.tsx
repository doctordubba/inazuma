...
const CHARACTERS = [
  ...
  },
  {
    ...
    element: "hydro",
    role: "Mono-Hydro Main DPS",
    weaponType: "Catalyst",
    set: "4pc Marechaussee Hunter",
    setAlt: "4pc Golden Troupe \u00b7 2pc Marechaussee / 2pc Heart of Depth",
    weapon: "Tome of the Eternal Flow",
    weaponAlt: "Cashflow Supervision \u00b7 Kagura's Verity \u00b7 Prototype Amber (F2P)",
    talents: "Normal \u203a\u203a Skill \u203a Burst",
    stats: [
    ...
    note: "Charged Attack scales off HP. Keep HP changing \u2014 frequent damage/heal swings drive Marechaussee CR stacks.",
    deep: {
      lore: "Iudex of the Court of Fontaine; last sovereign of the Hydro dragon line. He wears the form of a man because the form of a dragon would drown the city he is sworn to judge \u2014 when he weeps, the sky weeps; when he draws breath, the sea pulls back. His verdicts are impersonal as a tide.",
      kit: [
        "Charged Attack \u2014 Sourcewater Droplets: long-range Hydro stream; his primary damage source.",
        "Skill \u2014 Equitable Judgement: spawns Sourcewater Droplets he can absorb to upgrade his next CA into a piercing Triple-shot.",
        "Burst \u2014 O Tides, I Have Returned: heavy AoE Hydro pulse, scaling per Droplet collected.",
        "A1: gains stacking Hydro DMG bonus as enemy Hydro RES is debuffed; caps at three stacks. A4: a fraction of incoming healing converts to Hydro DMG.",
        "4pc Marechaussee Hunter: any HP change procs +12% Normal/Charged Attack DMG, stackable to +36%.",
      ],
      tips: [
        "Floor HP at 40 000. HP Sands is mandatory; Hydro Goblet is the obvious choice.",
        "Run 100% ER with Furina, 110\u2013120% solo. Prototype Amber is the cheap ER/HP+heal option that punches well above its rarity.",
        "Marechaussee wants frequent HP swings \u2014 pair with Furina or a pulse-healer over a top-up healer.",
      ],
      synergies: [
        { id: "xilonen", why: "DEF-scaling healing keeps Marechaussee stacks rolling; her 4pc grants +28% Hydro DMG via shared-element matching." },
        { id: "columbina", why: "Cryo applicator for permafreeze \u2014 Sourcewater Droplets land for free on locked targets, and Strayer's CR bonus blankets his crits." },
      ],
    },
  },
  {
    id: "columbina",
    name: "Columbina",
    epithet: "Damselette of the Frost-Veiled Lullaby",
    element: "cryo",
    role: "On-Field Freeze DPS",
    weaponType: "Catalyst",
    set: "4pc Blizzard Strayer",
    setAlt: "4pc Long Night's Oath \u00b7 4pc Golden Troupe",
    weapon: "Lullaby of Numinous Frost",
    weaponAlt: "Cashflow Supervision \u00b7 Kagura's Verity \u00b7 The Widsith (4\u2605)",
    talents: "Skill \u203a\u203a Burst \u203a Normal",
    stats: [
      { id: "sands", label: "Sands main stat", target: "ATK %" },
      { id: "goblet", label: "Goblet main stat", target: "Cryo DMG %" },
      { id: "circlet", label: "Circlet main stat", target: "CRIT DMG (Strayer gives +40% CR)" },
      { id: "atk", label: "Total ATK", target: "\u2265 2200" },
      { id: "cr", label: "CRIT Rate", target: "20 \u2013 40 % (+40% from set)" },
      { id: "cd", label: "CRIT DMG", target: "\u2265 200 %" },
      { id: "er", label: "Energy Recharge", target: "120 \u2013 140 %" },
    ],
    note: "Blizzard Strayer's +40% CR vs Frozen is everything \u2014 chase CRIT DMG, not CRIT Rate. Freeze partners only; Melt breaks the set's condition.",
    deep: {
      lore: "Third of the Fatui Harbingers; the Damselette who hums lullabies that hush a battlefield to ice. She does not raise her voice \u2014 the world quiets around her, and what she sings becomes still. Her colleagues call it Innocence. The Tsaritsa's archives call it a weapon.",
      kit: [
        "Skill \u2014 Hush of Numinous Frost: floats forward humming, applying Cryo in a slow AoE. Hold to enter Damselette state \u2014 sustained Cryo aura, infused Normal/Charged Attacks.",
        "Burst \u2014 Lullaby of the First Snow: lullaby pulse that Freezes affected enemies and lays a Cryo field; her CA inside the field upgrades into a piercing 'Hymn' shot.",
        "A1: while in Damselette state, +18% Cryo DMG to her and any teammate currently triggering Freeze.",
        "A4: every Freeze she triggers reduces her CA stamina cost by 12%, stackable to 60%.",
        "4pc Blizzard Strayer: +15% Cryo DMG, +40% CRIT Rate against Frozen targets \u2014 the math the rest of her build is built around.",
      ],
      tips: [
        "20\u201340% CRIT Rate substats only; Strayer's +40% does the rest. Going past 60% pre-set is wasted ratio \u2014 pivot to CRIT DMG.",
        "Freeze-only. Never pair with Pyro \u2014 Melt scales worse on her stat line AND breaks Strayer's condition mid-rotation.",
        "Lullaby of Numinous Frost is a CD weapon that punches above its level. Cashflow Supervision is the runner-up before pulling a sig.",
      ],
      synergies: [
        { id: "neuvillette", why: "His Hydro flood + her Cryo aura makes permanent Freeze trivial. Strayer's CR bonus runs the whole rotation for both." },
        { id: "xilonen", why: "Universal RES shred lifts Cryo damage; DEF-scaling healing keeps her Damselette state uninterrupted." },
      ],
    },
  },
];
