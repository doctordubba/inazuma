...
const CHARACTERS = [
  ...
  },
  {
    ...
    note: "Kit details are leak-based as of 6.6 pre-release \u2014 verify on launch. Grace of Kenosis is a FLAT ATK buff (same buff TYPE as Bennett, NOT a separate ATK %): the team gains flat ATK equal to 15 % of Nicole's ATK, capped at +600 flat ATK. Guidance of Theosis upgrade adds another +300 flat ATK, for a maximum of +900 flat ATK. Bennett with Aquila Favonia still delivers ~+1200 \u2014 Nicole is the smaller raw buff but adds a 250 %-Pyro shield, Coordinated Attacks, and no element-infusion downside. Build ATK on Nicole to ~4000 to cap the buff (extra ATK past that still grows the shield and her CAs). Methexis A4: after Skill she watches the active character for 20 s; the buff upgrades from Grace to Guidance after 3 s on field \u2014 INSTANT if the watched character is Hexerei (Mona / Durin / Varka).",
    deep: {
      ...
      synergies: [
        ...
        { id: "neuvillette", why: "Outside Hexerei: Nicole on Tenacity 4pc with Coordinated Attacks taking Hydro element while Neuvillette CAs = uncapped Hydro Coordinated DMG riding his RES shred. Shield protects his HP buffer. Furina interaction: clean multiplicative stack \u2014 Fanfare is a DMG % bonus, Nicole's Grace is flat ATK, they live in different terms of the formula and BOTH apply. Furina-Nicole-Neuvillette is one of the highest-ceiling Mono-Hydro lines available." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    note: "Kit details are leak-based as of 6.6 pre-release — verify on launch. The UNUSUAL buffer: instead of granting flat ATK (Bennett / Nicole) or ATK % (NO / Tenacity), she grants Ringing Inspiration — a DMG % bonus on the active character's NA / CA / Plunge / Skill / Burst, scaling on Prune's ATK exceeding 1000 (0.01 % per ATK over 1000, capped at +35 % at 4500 ATK). This lives in the DMG_Bonus term of the formula, so it stacks MULTIPLICATIVELY with Bennett / Nicole's flat ATK AND with NO / Tenacity / Pyro Resonance ATK % AND with Furina's Fanfare. C6 layers +350 flat ATK on top of that DMG % bonus.",
    deep: {
      ...
      kit: [
        ...
        "C6 — Bell-Bound Oath: Ringing Inspiration also grants +350 flat ATK to recipients on top of the DMG % bonus. C6 completes her buffer profile — she becomes a Bennett-tier flat-ATK source AND keeps her DMG % bonus.",
      ],
      tips: [
        ...
        "C2 is the practical investment ceiling for most accounts. C6 turns her into a Bennett-tier flat-ATK buffer ON TOP of the DMG % buff — strong, but 4★ con costs make C6 realistic only with heavy banner luck.",
      ],
      synergies: [
        { id: "nicole", why: "Hexenzirkel coven-mates. Nicole's flat-ATK Grace buffs Prune toward the 1000-ATK Ringing Inspiration threshold; Prune's presence triggers Nicole's Methexis instant-upgrade on swap. Stack: Prune's DMG % buff multiplies with Nicole's flat ATK — different terms, both apply on every DPS hit." },
        ...
        { id: "mavuika", why: "Pyro DPS host. Bell Swirls her Pyro auras → 4pc VV shreds Pyro RES −40 %; Prune's A4 DMG % feeds her Crucible swings and Sacred Flame pulses. Mavuika doesn't depend on reactions so Prune's contribution is RES shred + DMG % buff + Burst Swirl damage — all clean." },
      ],
    },
  },
  {
    ...
    reactions: [
      {
        ...
        examples: [
          ...
          { id: "nicole", role: "Hexenzirkel coven. Universal flat-ATK buffer + shielder + Coordinated Attack DPS." },
          { id: "prune", role: "Hexenzirkel Witch-Hunter. DMG % buffer (Ringing Inspiration) + Swirl Sub-DPS + Anemo applicator." },
