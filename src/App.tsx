...
const CHARACTERS = [
  ...
  },
  {
    ...
    note: "Kit details are leak-based as of 6.6 pre-release \u2014 verify on launch. Every part of her kit scales on her OWN ATK, not the active character's. Shield absorbs Pyro at 250 % (cleanest Burgeon shielder in the game). Methexis A4: after Skill she watches the active character for 20 s; the Grace-of-Kenosis ATK buff upgrades to Guidance-of-Theosis after 3 s on field \u2014 INSTANT if the watched character is Hexerei (Mona / Durin / Varka). The first 5\u2605 that legitimately competes with Bennett for the universal-buffer slot because her buff has no element-infusion downside.",
    deep: {
      ...
      kit: [
        "Skill \u2014 Grace of Kenosis: deals AoE Pyro DMG, grants all party members the Grace of Kenosis ATK buff, and plants the Shield of Blazing Light. Shield strength scales on Nicole's ATK; absorbs Pyro at 250 % effectiveness; ~20 s duration.",
        "Burst \u2014 Silent Contemplation: AoE Pyro DMG, then Nicole enters Silent Contemplation mode. While in this mode, when a nearby party member hits an enemy, Nicole launches an Arcane Projection Coordinated Attack of the ACTIVE CHARACTER's element, scaling on NICOLE'S ATK.",
        ...
        "A4 \u2014 Methexis: after Skill, Nicole observes the active character for 20 s. If they stay on field for 3 s, Grace of Kenosis upgrades to Guidance of Theosis (a larger ATK buff + Coordinated Attack DMG bonus). If the observed character is Hexerei, the upgrade is INSTANT.",
        "C2 (leak) \u2014 adds Pyro RES shred on Coordinated Attack hit and increases the Burst projection count.",
        "C6 (leak) \u2014 Coordinated Attacks fire multi-strike or crit twice; details still noisy, verify on launch.",
      ],
      tips: [
        "Build ATK %, NOT HP. Her shield, her ATK buff, and her Coordinated Attacks all scale on ATK \u2014 there is no HP-scaling lever on her. 4pc Tenacity of the Millelith is BiS because her Skill grants a shield, which triggers Millelith's Mercy (+20 % party ATK on top of Grace of Kenosis).",
        "Hexerei team = instant Methexis upgrade. Run her with Mona, Durin, or Varka and Guidance of Theosis fires on the swap \u2014 no 3-second wait. Outside Hexerei the buff is still strong; it just takes a moment to reach full value.",
        "Coordinated Attacks adopt the active character's element. She is therefore element-agnostic as a support: Hyperbloom Ororon \u2192 Electro projections; on-field Mona \u2192 Hydro projections that vape on her own Pyro residue.",
        ...
        "Bennett comparison: Nicole's ATK buff has no Pyro-infusion downside and is universal across all reaction comps. The tradeoff is NO healing \u2014 pair her with a healer or a Furina rotation if your team can't sustain on shield alone.",
      ],
      synergies: [
        ...
        { id: "varka", why: "Hexerei tribe-mate. Varka's on-field Swirls feed Nicole's Anemo Coordinated Attacks, which then re-swirl with Pyro from her Skill residue. Methexis upgrades on swap. ADCFRW's +20 % CR triggers on both with two Hexerei in party." },
        { id: "neuvillette", why: "Outside Hexerei: Nicole on Tenacity 4pc with Coordinated Attacks taking Hydro element while Neuvillette CAs = uncapped Hydro Coordinated DMG riding his RES shred. Shield protects his HP buffer; her ATK buff competes with Furina in some setups (but does NOT stack with a real Furina rotation \u2014 see ATK-stacking entry on Reactions page)." },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    note: "Her Burst applies Omen — every elemental DMG instance on the marked target gets +60 % bonus damage. Omen is the single largest party-wide DMG amplifier short of Furina's Fanfare when it's up, but the window is short (~4-5 s), so plant it at the start of the DPS's burst cycle. Thrilling Tales of Dragon Slayers (free 3★) is unironically BiS for SUPPORT Mona — its passive transfers +48 % ATK to the next on-field character on swap.",
    deep: {
      ...
      kit: [
        ...
        "Omen (Burst passive) — every elemental DMG instance on the marked target is amplified +60 % (Hexenzirkel-buffed value in 6.x). Adds +5 % per additional Hexerei in the party.",
      ...
      tips: [
        ...
        "Omen does NOT stack with another Omen — only the higher value applies on the same target. Two Monas in coop don't double up. Within a single team, scale Omen by stacking Hexerei members (Durin, Varka, Nicole), not by re-applying it.",
      ...
      synergies: [
        ...
        { id: "durin", why: "Hexerei tribe-mate. Omen lifts Durin's off-field Pyro instances and Vape multipliers; two Hexerei in party triggers his A1 +75 %. Lauma / Mona seeding Vape is the textbook reaction line for him." },
...
const REACTION_GROUPS = [
  ...
  },
  {
    ...
    formula:
      "Hexerei tag bonuses · ADCFRW 4pc: +20 % CRIT Rate to wearer when any other Hexerei is in party · Durin A1 reaches +75 % at 2 Hexerei · Mona Omen: +5 % amp per Hexerei · Nicole Methexis: instant Guidance-of-Theosis upgrade when the observed character is Hexerei.",
    reactions: [
      {
        id: "hexerei-roster",
        name: "Hexerei roster",
        ...
        elements: [],
        short: "Four playable Hexerei: Mona, Nicole, Durin, Varka.",
        multiplier: "Tag — see formula above",
        details: [
          "Hexenzirkel is the coven of witches in Genshin lore: Alice, Mona, Rhinedottir, the Dornman bard, 'N' (Nicole), and various historic members. In gameplay terms, the playable members of the coven share the Hexerei tag.",
          "Set bonus — A Day Carved from Rising Winds (4pc): wearer gains +20 % CRIT Rate while at least one OTHER Hexerei is in the party. Varka's default set; pairs with Mona/Nicole/Durin to trigger.",
          "Durin A1 — when 2 or more Hexerei are in the party, his Hexerei-scaling A1 damage bonus jumps from base to +75 %.",
          "Mona Omen (Burst) — Hexenzirkel passive adds +5 % amplification per Hexerei in the party on top of the base +60 % Omen value.",
          ...
          "Two-Hexerei is the practical floor (triggers ADCFRW + Durin A1 + Methexis instant). Three-Hexerei stacks ADCFRW on every wearer and unlocks the Omen +15 % cap, but starts to crowd out a healer slot. Four-Hexerei (Mona + Nicole + Durin + Varka) is the meme ceiling — no healer, sustain entirely on Nicole's shield.",
        ],
        examples: [
          { id: "mona", role: "Hexenzirkel coven. Omen amplifier + Hydro applicator." },
          { id: "nicole", role: "Hexenzirkel coven. Universal ATK buffer + shielder + Coordinated Attack DPS." },
    ...
    reactions: [
      ...
      },
      {
        ...
        examples: [
          ...
          { id: "nicole", role: "Grace of Kenosis scales on Nicole's TOTAL ATK — stack ATK % on her freely." },
        ],
      },
      {
        id: "fmt-atk-stacking",
        ...
        details: [
          "ATK % from different sources adds together: 4pc Noblesse Oblige (+20 %) + Pyro Resonance (+25 %) + Nicole's Grace of Kenosis (+ % varies) + ATK % Sands (+46.6 %) + substats = ALL one pool, applied as (1 + total) × Base ATK.",
          "Bennett's buff is FLAT ATK, not ATK %. It adds to the flat-ATK term — does not enter the ATK % pool, does not multiply with it. This is why Bennett stacks cleanly with NO / Pyro Resonance / etc.",
          ...
          "Practical: don't run two of the same 4pc team-buff set. Run ONE NO + ONE Tenacity + ONE Instructor → three different named buffs, all stacking additively into one ATK pool.",
          ...
          "Why a Furina rotation does NOT stack with Nicole's buff on the same multiplier slot: both can apply, but they enter different terms — Furina's Fanfare is a multiplicative DMG % bonus, Nicole's Grace is an ATK % bonus. Both apply, but you can't double-dip the same slot.",
        ],
        examples: [
          { id: "bennett", role: "Flat ATK buff source — adds to flat term, doesn't compete with ATK %." },
          { id: "nicole", role: "ATK % buff source — different name from Bennett, both stack on the DPS." },
          { id: "mavuika", role: "Recipient — total ATK lifts her Sacred Flame pulses and Crucible swings." },
        ],
      },
      {
        id: "fmt-res-shred",
        ...
        details: [
          "Default enemy RES is 10 % for most elements. RES SHRED subtracts: 4pc Viridescent Venerer = −40 % swirled element; Zhongli Skill = −20 % universal; Xilonen Nightsoul = element-agnostic −% scaling on DEF; various character A4s.",
