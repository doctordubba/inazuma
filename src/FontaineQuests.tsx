...
const QUESTS = [
  ...
  {
    id:40, tier:1, chain:"standalone",
    name:"Semi-Automatic Forging",
    time:"2-3 min",
    region:"Court of Fontaine — Vasari Passage",
    activate:"Talk to Estelle after completing AQ Ch4 Act 2. Auto-unlocks alongside reputation.",
    prereqs:"AQ Chapter 4 Act 2 completed",
    notes:"Simple talk-and-go quest. 4 Hero's Wit in 2 minutes is the best HW/min in all of Fontaine.",
    rewards:"10,000 Mora · 4 Hero's Wit",
    mora: 10000, heroWit: 4,
    fandom:"https://genshin-impact.fandom.com/wiki/Semi-Automatic_Forging",
  },
  {
    id:41, tier:1, chain:"standalone",
    name:"In Expert Company? (I)",
    time:"3-5 min",
    region:"Court of Fontaine — Fountain of Lucine",
    activate:"Talk to Ms. Qiu near the fountain after AQ Ch4 Act 2.",
    prereqs:"AQ Chapter 4 Act 2 completed",
    notes:"Fight nearby monsters to retrieve a Film Kamera. Quick combat quest.",
    rewards:"15,000 Mora · 2 Hero's Wit",
    mora: 15000, heroWit: 2,
    game8:"https://game8.co/games/Genshin-Impact/archives/422094",
  },
  {
    id:42, tier:1, chain:"standalone",
    name:"In Expert Company? (II)",
    time:"3-5 min",
    region:"Court of Fontaine — northwest of Opera",
    activate:"Talk to Ms. Qiu again after completing Part I.",
    prereqs:"In Expert Company? (I) completed",
    notes:"Retrieve a box of films from the water. 31.5k Mora for under 5 min is outstanding. Unlocks Poisson Seafood Soup recipe.",
    rewards:"31,500 Mora · 3 Hero's Wit · Poisson Seafood Soup recipe",
    mora: 31500, heroWit: 3,
    game8:"https://game8.co/games/Genshin-Impact/archives/422109",
  },
  {
    id:43, tier:1, chain:"standalone",
    name:"A Fontainian Message",
    time:"5-10 min",
    region:"Court of Fontaine / Elton Trench (underwater)",
    activate:"Talk to Sonny after completing Aqueous Tidemarks.",
    prereqs:"Aqueous Tidemarks completed",
    notes:"Go underwater, defeat enemies, fight Virgil. Short combat quest.",
    rewards:"15,000 Mora · 2 Hero's Wit · 30 Primogems",
    mora: 15000, heroWit: 2,
    game8:"https://game8.co/games/Genshin-Impact/archives/422032",
  },
  {
    id:44, tier:1, chain:"standalone",
    name:"The Final Question",
    time:"5-10 min",
    region:"Narzissenkreuz Ordo — Institute of Natural Philosophy",
    activate:"Talk to Seymour in the Institute of Natural Philosophy after completing Ancient Colors chain.",
    prereqs:"Aqueous Tidemarks + Ancient Colors chain completed",
    notes:"Mostly dialogue/cutscene. 26.5k Mora for under 10 min of dialogue.",
    rewards:"26,500 Mora · 20 Primogems",
    mora: 26500,
    game8:"https://game8.co/games/Genshin-Impact/archives/422076",
  },
  {
    id:45, tier:2, chain:"standalone",
    name:"Villains",
    time:"10 min",
    region:"Fontaine Research Institute of Kinetic Energy Engineering",
    activate:"Find Blanche (little girl) south of the eastmost Teleport Waypoint in the FRIKE region.",
    prereqs:"FRIKE area accessible (4.1)",
    notes:"Save Blanche from Treasure Hoarders, investigate clues, Hydro mechanism trial. 5 Hero's Wit for 10 min is excellent. Blueprint: Pure Water.",
    rewards:"15,000 Mora · 5 Hero's Wit · 40 Primogems · Blueprint: Pure Water",
    mora: 15000, heroWit: 5,
    game8:"https://game8.co/games/Genshin-Impact/archives/428610",
  },
  {
    id:46, tier:2, chain:"standalone",
    name:"Still Mouthwatering!",
    time:"10-15 min",
    region:"Beach north of Poisson",
    activate:"Return to Henri after collecting all 7 Mysterious Cores across Fontaine.",
    prereqs:"Truly Mouthwatering! completed + all 7 Mysterious Cores found",
    notes:"Sequel to Truly Mouthwatering!. The quest itself is short — the time-consuming part is finding cores beforehand. 2 Precious Chests.",
    rewards:"33,500 Mora · 4 Hero's Wit · 40 Primogems (from 2 Precious Chests)",
    mora: 33500, heroWit: 4,
    game8:"https://game8.co/games/Genshin-Impact/archives/422147",
  },
  {
    id:47, tier:3, chain:"standalone",
    name:"Aqueous Tidemarks",
    time:"20-30 min",
    region:"Court of Fontaine (underwater)",
    activate:"Talk to Virgil near the Statue of the Seven in Court of Fontaine.",
    prereqs:"Fontaine accessible",
    notes:"Exploration and puzzle-solving to unlock the Institute of Natural Philosophy. Prerequisite for many other quests including The Final Question and A Fontainian Message.",
    rewards:"33,500 Mora · 3 Hero's Wit · 40 Primogems · 5 Mystic Enhancement Ore",
    mora: 33500, heroWit: 3,
    game8:"https://game8.co/games/Genshin-Impact/archives/422070",
  },
  {
    id:48, tier:3, chain:"standalone",
    name:"Book of Esoteric Revelations",
    time:"20-30 min",
    region:"Beryl Region — Merusea Village",
    activate:"Talk to Canotila in Merusea Village.",
    prereqs:"Merusea Village accessible",
    notes:"Find 3 Enigmatic Pages scattered across Fontaine. Puzzles + Rifthound combat. Prerequisite for Through the Looking Glass.",
    rewards:"34,000 Mora · 4 Hero's Wit · 50 Primogems · 6 Mystic Enhancement Ore",
    mora: 34000, heroWit: 4,
    game8:"https://game8.co/games/Genshin-Impact/archives/421880",
  },
];
...
const ORDER_NOTE = [
  ...
  { step:12, text:"Ultra-fast Mora sweep: Semi-Automatic Forging (2 min, 10k+4HW), In Expert Company I+II (6 min total, 46.5k+5HW), The Final Question (8 min, 26.5k). All dialogue-heavy, combine in one 15-min session for ~83k Mora + 9 HW." },
  { step:13, text:"Villains (10 min, 5 HW) at the FRIKE region is the best Hero's Wit-per-minute standalone in Fontaine. Stack with Still Mouthwatering! (33.5k+4HW) if you have the 7 Mysterious Cores ready." },
];
