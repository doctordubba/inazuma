...
const quests = [
  ...
  { id:7, tier:2, chain:"standalone", name:"Nine Pillars of Peace", time:"20-30 min", region:"Cuijue Slope (south of Liyue Harbor)", activate:"Visit Cuijue Slope after fully leveling up the Liyue Statue of the Seven (the statue gates the pillars puzzle).", prereqs:"Liyue Statue of the Seven fully leveled · party ready for a 3-stage domain", notes:"Place geocullus stones in the nine pillars to open the sealed domain. Boss layout: 1× Ruin Guard, several Geovishap Hatchlings, finishing with a Ruin Hunter.", rewards:"50 Primogems · Adv EXP · Mora · Hero's Wit · Mystic Enhancement Ore", heroWit: 1, game8:"https://game8.co/games/Genshin-Impact/archives/305610" },
  { id:8, tier:2, chain:"chasm", name:"Chasm Spelunkers", time:"20-30 min", region:"The Chasm — surface camp + mines entrance", activate:"Talk to Muning at the Chasm Surface Adventurer Camp. Part of The Chasm Delvers series.", prereqs:"The Chasm region accessible · The Chasm Charters started", notes:"Help the Chasm survey team start mapping the underground. Required gate quest into the Chasm Delvers chain (which then unlocks Surreptitious Seven-Star Seal Sundering, First Miasmic Contact, and the rest).", rewards:"30 Primogems · 200 AR EXP · 20,000 Mora · 2 Hero's Wit · 1 Lumenstone Ore", mora: 20000, heroWit: 2, game8:"https://game8.co/games/Genshin-Impact/archives/372643" },

  // ───────── TIER 3 — MEDIUM (30-60 min) ─────────
  { id:9, tier:3, chain:"standalone", name:"The Chi of Guyun", time:"30-45 min", region:"Guyun Stone Forest (south Liyue coast)", activate:"Reach Guyun Stone Forest. Investigate the four scattered stone tablets.", prereqs:"Guyun Stone Forest accessible", notes:"Multi-stop puzzle reading four scattered stelae, each guarded. The final stop spawns a small set of waves. Decent payoff for the time.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit", heroWit: 1, fandom:"https://genshin-impact.fandom.com/wiki/The_Chi_of_Guyun" },
  { id:10, tier:3, chain:"standalone", name:"Treasure Lost, Treasure Found", time:"30-45 min", region:"Lingju Pass / Dunyu Ruins", activate:"Talk to the Treasure Hoarder Soraya at Lingju Pass after Mondstadt Chapter completion.", prereqs:"Prologue Chapter completed · Lingju Pass accessible", notes:"Early Liyue intro quest. Three-act mini-chain: investigate Hoarder ledgers, fetch artefacts across the area, then a brief showdown.", rewards:"80 Primogems (highest single Liyue world-quest payout) · Adv EXP · Mora · Hero's Wit", heroWit: 1, fandom:"https://genshin-impact.fandom.com/wiki/Treasure_Lost,_Treasure_Found" },
  { id:11, tier:3, chain:"story", name:"Zhongli I — Sal Flore", time:"40-50 min", region:"Liyue Harbor → Mt. Tianheng", activate:"Story Quest menu. Spend 1 Story Key. Take Katheryne's Adventurers' Guild commission.", prereqs:"AR 32 + Liyue Archon Quest Act III completed + 1 Story Key", notes:"Historia Antiqua Chapter — Act I. Walk Liyue's funerary customs with Zhongli; mostly dialogue with a few light combat beats.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit · Zhongli ascension materials", mora: 26925, heroWit: 3, game8:"https://game8.co/games/Genshin-Impact/archives/311299" },
  { id:12, tier:3, chain:"story", name:"Zhongli II — No Mere Stone", time:"45-60 min", region:"Liyue Harbor → Jueyun Karst → Dunyu Ruins", activate:"Story Quest menu. Spend 1 Story Key. Take the new Katheryne commission after Act I.", prereqs:"AR 40 + Historia Antiqua Act I (Sal Flore) + AQ Ch I Act IV 'We Will Be Reunited' + 1 Story Key", notes:"Historia Antiqua Chapter — Act II. Investigate missing miners; the trail leads to one of Zhongli's old contracts. Released in 1.5.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit", mora: 26925, heroWit: 3, game8:"https://game8.co/games/Genshin-Impact/archives/328779" },
  { id:13, tier:3, chain:"story", name:"Hu Tao — Yet the Butterfly Flutters Away", time:"45-60 min", region:"Liyue Harbor — Wangsheng Funeral Parlor → Wuwang Hill", activate:"Story Quest menu. Spend 1 Story Key. Hu Tao is waiting near Wangsheng Funeral Parlor.", prereqs:"AR 40 + 'Yakshas: The Guardian Adepti' (Xiao Story Quest Act I) + 1 Story Key", notes:"Papilio Charontis Chapter — Act I. The Wangsheng Funeral Parlor on a working day. Quiet horror tones, escort through Wuwang Hill, lots of memorable dialogue.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit · Hu Tao ascension materials", mora: 26925, heroWit: 3, game8:"https://game8.co/games/Genshin-Impact/archives/321338" },
  { id:14, tier:3, chain:"story", name:"Xiao — Butterfly's Dream", time:"45-60 min", region:"Wangshu Inn → Dihua Marsh", activate:"Story Quest menu. Spend 1 Story Key. Find Xiao at Wangshu Inn's top floor.", prereqs:"AR 32 + AQ Ch I Act III + 1 Story Key", notes:"Alatus Chapter — Act I. Yaksha lore, Xiao's old battles, and the Karma that follows him. Heavier combat than most Story Quests.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit · Xiao ascension materials", mora: 26925, heroWit: 3, fandom:"https://genshin-impact.fandom.com/wiki/Alatus_Chapter" },
  { id:15, tier:3, chain:"story", name:"Childe — Father and Son", time:"45-60 min", region:"Liyue Harbor → Mt. Aozang", activate:"Story Quest menu. Spend 1 Story Key. Childe is waiting near Northland Bank in Liyue Harbor.", prereqs:"AR 32 + AQ Ch I Act III + 1 Story Key", notes:"Monoceros Caeli Chapter — Act I. Childe's little brother Teucer visits Liyue. Comedic on the surface, with the inevitable Fatui edge underneath.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit", mora: 26925, heroWit: 3, fandom:"https://genshin-impact.fandom.com/wiki/Monoceros_Caeli_Chapter" },
  { id:16, tier:3, chain:"story", name:"Ningguang — Sal Terrae", time:"45-60 min", region:"Liyue Harbor — Jade Chamber", activate:"Story Quest menu. Spend 1 Story Key. Pick up the quest at Northland Bank.", prereqs:"AR 32 + AQ Ch I Act III + 1 Story Key", notes:"Lapis Dei Chapter — Act I. Politics, gossip, and a quiet display of why Ningguang runs Liyue's commerce. Mostly investigation + dialogue.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit · Ningguang ascension materials", mora: 26925, heroWit: 3, fandom:"https://genshin-impact.fandom.com/wiki/Lapis_Dei_Chapter" },
  { id:17, tier:3, chain:"story", name:"Keqing — Driving Thunder", time:"45-60 min", region:"Liyue Harbor → Yujing Terrace", activate:"Story Quest menu. Spend 1 Story Key. Keqing summons you to Yujing Terrace.", prereqs:"AR 40 + AQ Ch I Act III + 1 Story Key", notes:"Trail of Drake and Serpent — Act I. Keqing investigates a smuggling case; her Mondstadt-meets-Liyue worldview gets the spotlight. Reward 4★, but the writing is top-shelf.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit · Keqing ascension materials", mora: 26925, heroWit: 3, fandom:"https://genshin-impact.fandom.com/wiki/Trail_of_Drake_and_Serpent" },

  // ───────── TIER 4 — LONG / GATED (60 min+) ─────────
  { id:18, tier:4, chain:"story", name:"Ganyu — Sea of Clouds, Sea of People", time:"60-90 min", region:"Liyue Harbor → Jueyun Karst", activate:"Story Quest menu. Spend 1 Story Key. Ganyu is at Yujing Terrace.", prereqs:"AR 40 + AQ Ch I Act III + 1 Story Key", notes:"Sinae Unicornis Chapter — Act I. Ganyu introduces you to the older adepti of Jueyun Karst. Long, dialogue-heavy, sets up most of the Adepti lore that pays off in Xianyun's release.", rewards:"60 Primogems · Adv EXP · Mora · Hero's Wit · Ganyu ascension materials", mora: 26925, heroWit: 3, fandom:"https://genshin-impact.fandom.com/wiki/Sinae_Unicornis_Chapter" },
